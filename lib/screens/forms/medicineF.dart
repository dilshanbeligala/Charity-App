...
class Med_form extends StatefulWidget {
  const Med_form({super.key});

  @override
  State<Med_form> createState() => _Med_formState();
}

class _Med_formState extends State<Med_form> {
  @override
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Add New Medicine Charity Requirements",
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            decoration: InputDecoration(
                              hintText: "Hospital or other place",
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            decoration: InputDecoration(
                              hintText: "List of medicine items",
